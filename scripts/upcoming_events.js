...
let filterUE = filterUpcomingEvents(data.events, data.currentDate)
...
function superFilter(){
    let firstFilter = searchBar(filterUE)
...
printCards(filterUE)
showCategories(deleteDuplicate(filterCategories(filterUE)))
