const homeEvents = document.getElementById('cards_past_events');
...
let filterPE = filterUpcomingEvents(data.events, data.currentDate)
...
function superFilter(){
    let firstFilter = searchBar(filterPE)
...
printCards(filterPE)
showCategories(deleteDuplicate(filterCategories(filterPE)))
